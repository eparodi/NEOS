#!/bin/bash
qemu-system-x86_64 -hda Image/x64BareBonesImage.qcow2 -device rtl8139,netdev=net0,mac=DE:AD:BE:EF:22:22 -netdev tap,id=net0,ifname=tap1,script=no,downscript=no
